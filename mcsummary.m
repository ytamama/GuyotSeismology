...
if plotting == 1
    ...
    title(titlestr);
    hold on
    minline=line([minvar, minvar], ylim, 'LineWidth', 0.5, 'Color',...
        'r','LineStyle','--');
    maxline=line([maxvar, maxvar], ylim, 'LineWidth', 0.5, 'Color',...
        'b','LineStyle','--');
    meanline=line([meanvar, meanvar], ylim, 'LineWidth', 0.5, ...
        'Color', 'g','LineStyle','--');
    medline=line([medvar, medvar], ylim, 'LineWidth', 0.5, 'Color', ...
        'y','LineStyle','--');
    hold off
